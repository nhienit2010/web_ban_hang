...
if ( !isset($_SESSION['user']) || $_SESSION['user'] !== 'admin') {
    echo "<script>alert('Chỉ admin mới có thể vào khu vực này!!'); window.location='/';</script>";
    exit();
}
...
if (isset($_GET['user_del'])) {
    ...
    echo '
        <script>
            ...
            window.location = "admin.php?action=account";
        </script>';
}
...
if (isset($_GET['product_del'])) {
    ...
    echo '
        <script>
            ...
            window.location = "admin.php?action=product";
        </script>';
}
